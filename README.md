# coffee-review-template
* A simple model for a coffee review website using AngularJS
* Uses angular-seed

#Acessing Website
* Make sure you have node.js and nmp installed
* Clone this repo and follow the instructions for angular-seed below to install dependencies
